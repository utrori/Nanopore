...
if __name__ == '__main__':
    ...
    result = analyze_fastq_by_header('rDNA_reads.fastq', '@8b2ae911-3a60-4b84-9b27-bc4f6bc2ff89', split_length)
    for i in result:
        print(i)
    quit()
    summary = []
    for TRs in set_of_TRs:
        if '@8b2ae911-3a60-4b84-9b27-bc4f6bc2ff89'in TRs[0]:
            for TR in TRs[1]:
                print(TR)
    for i in set_of_TRs:
    ...
    #analyze_fastq_by_header('rDNA_reads.fastq', '@a0acf9ce-8e66-49be-9f48-4ae55e0921d9', split_length)
    #print(analyze_split_reads('single_split_mapped.sam', split_length))
